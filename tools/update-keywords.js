 ...
 *
 * @param {String} source - Path to downloaded VimScript file
 * @param {String} target - Path to Atom's grammar file
 */
function update(source, target){
	...
	let vimSyn    = fs.readFileSync(source).toString();
	let atomSyn   = fs.readFileSync(target).toString();
	...
	fs.writeFileSync(target, atomSyn);
}
...
update(vimSyntax, "../grammars/viml.cson");
